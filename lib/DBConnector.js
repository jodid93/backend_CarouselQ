...
module.exports.createTables = function createTables( cb ){
  ...
  pg.connect(DATABASE, function (error, client, done) {
    ...
    var query = 'CREATE TABLE if not exists Queues( queue_id VARCHAR(10) NOT NULL, users VARCHAR(100));';
    client.query(query, function (err, result) {
      if (err) {
        ...
        var query2 = 'CREATE TABLE if not exists UserInfo( UserInfo_name VARCHAR(10) NOT NULL, UserInfo_songs TEXT[], UserInfo_hashName VARCHAR(100));';
