  ...
  pg.connect(DATABASE, function (error, client, done) {
    ...
    client.query(query, function (err, result) {
      if (err) {
        ...
        var query2 = 'CREATE TABLE if not exists UserInfo( UserInfo_name VARCHAR(100) NOT NULL, UserInfo_songs TEXT[], UserInfo_hashName TEXT[], UserInfo_Qowner boolean);';
...
module.exports.addNewUser = function addNewUser(username, queueId, hashedUN, owner, cb){
  pg.connect(DATABASE, function (error, client, done) {
    ...
    var values = [username,arrHash2,owner];
    var query = 'INSERT INTO userinfo (userinfo_name, userinfo_hashname, UserInfo_Qowner) VALUES($1, $2, $3)';
