...
module.exports.createTables = function createTables( cb ){
  ...
  pg.connect(DATABASE, function (error, client, done) {
    ...
    console.log('FUCK YEAH! I AM CONNECTED!');
    var query = 'CREATE TABLE if not exists Queues( id serial NOT NULL, users VARCHAR(100));';
    client.query(query, function (err, result) {
      ...
      if (err) {
        ...
        console.log('FUCK YEAH! I HAVE A TABLE!!');
        return cb(false);
      }
    });
  });
