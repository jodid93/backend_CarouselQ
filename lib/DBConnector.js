  ...
  pg.connect(DATABASE, function(error,client,done){
    if(error){
      ...
      if(err){
        ...
        var values2 = [trackUri,trackName,trackBand,trackDur];
        var query2 = 'insert into songs (songs_uri, song_name, song_band, song_skipvotes, song_duration) values ( $1, $2, $3, 0, $4)';
